...
fn main() -> ! {
    ...
    // let projector_power = (9016, 4440,  618, 1632,  620, 1632,  618, 506,  624, 508,  618, 506,  618, 510,  620, 510,  614, 1634,  622, 1632,  618, 508,  616, 1634,  618, 510,  618, 1632,  618, 508,  620, 1634,  616, 510,  618, 508,  618, 510,  618, 510,  618, 508,  618, 1632,  618, 512,  616, 510,  620, 1630,  620, 1634,  618, 1634,  618, 1636,  618, 1630,  620, 508,  620, 1632,  616, 1636,  616, 510,  618, 40806,  9018, 4438,  620, 1634,  618, 1634,  618, 510,  620, 504,  620, 510,  618, 510,  618, 506,  618, 1634,  618, 1632,  618, 510,  618, 1632,  622, 508,  618, 1632,  620, 508,  620, 1632,  618, 510,  616, 512,  618, 504,  620, 510,  618, 506,  620, 1632,  620, 506,  620, 510,  618, 1634,  618, 1634,  618, 1632,  618, 1634,  620, 1632,  616, 512,  614, 1636,  618, 1636,  614, 512,  618);

    // SONY 68114
    // let amp_input_dvd = (2462, 556,  666, 544,  1242, 554,  1240, 558,  668, 544,  1242, 556,  664, 548,  666, 544,  668, 546,  662, 550,  664, 544,  668, 542,  1244, 556,  666, 544,  668, 544,  668, 546,  1242, 556,  666, 546,  1240, 556,  666, 546,  668, 14836,  2470, 550,  668, 546,  1242, 556,  1240, 554,  668, 548,  1240, 558,  666, 546,  668, 546,  662, 548,  664, 548,  666, 544,  666, 544,  1244, 558,  664, 548,  664, 548,  664, 548,  1242, 556,  666, 546,  1238, 562,  666, 544,  668, 14834,  2468, 556,  666, 546,  1240, 558,  1242, 554,  666, 546,  1242, 558,  666, 544,  668, 546,  666, 544,  666, 548,  666, 546,  666, 544,  1244, 556,  664, 550,  666, 544,  666, 548,  1240, 558,  664, 548,  1238, 560,  664, 548,  664, 14836,  2466, 556,  666, 546,  1240, 556,  1242, 560,  666, 546,  1242, 554,  666, 546,  664, 546,  666, 546,  666, 546,  666, 546,  666, 544,  1244, 558,  664, 546,  668, 542,  668, 546,  1240, 556,  664, 546,  1242, 558,  664, 548,  666);

    // PANASONIC 40040D08BCB9
    // let tv_power = (3514, 1702,  466, 400,  472, 1268,  470, 398,  472, 398,  468, 400,  472, 398,  470, 400,  470, 398,  470, 396,  470, 400,  470, 398,  470, 398,  470, 400,  470, 1268,  470, 398,  472, 396,  474, 396,  470, 400,  472, 396,  472, 396,  474, 1266,  468, 1272,  470, 398,  472, 1264,  474, 396,  468, 402,  468, 400,  470, 396,  474, 1268,  470, 398,  470, 398,  472, 396,  472, 1268,  470, 398,  470, 1266,  472, 1266,  472, 1266,  470, 1270,  470, 398,  470, 398,  470, 1268,  468, 400,  468, 1270,  472, 1268,  470, 1266,  472, 396,  474, 396,  470, 1270,  470);

    loop {
        if button_1.is_high().ok().unwrap() {
            // amp_input_game

            // Its a just a code to trial. I need to find out how to write sending IR commands.
            for (i, val) in amp_input_game.iter().enumerate() {
                if i % 2 == 0 {
